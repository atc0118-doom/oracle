...
const formula=data.formula||fallback.formula;
const rows=formula.weights.map(w=>{const contribution=(w[1]*w[2]/100); return [w[0],w[1],w[2],contribution]});
